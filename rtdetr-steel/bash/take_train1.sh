...
# 基础配置
MEMORY_THRESHOLD=6000        # 显存阈值
SLEEP_INTERVAL=300          # 轮询间隔(秒)
GPU_LIST=(2 3)             # 指定要使用的GPU列表，例如(2 3)表示只使用GPU2和GPU3
MAX_TASKS_PER_GPU=3        # 每张GPU上最多运行的rtdetr任务数量

# 定义训练配置列表
declare -a CONFIG_LIST=(
"rtdetr-DCNV2-Dynamic:rtdetr-DCNV2-Dynamic"
"rtdetr-DCNV3:rtdetr-DCNV3"
"rtdetr-DCNV4:rtdetr-DCNV4"
"rtdetr-DEConv:rtdetr-DEConv"
"rtdetr-DRB:rtdetr-DRB"
"rtdetr-DualConv:rtdetr-DualConv"
"rtdetr-DySnake:rtdetr-DySnake"
"rtdetr-EMBSFPN:rtdetr-EMBSFPN"
"rtdetr-Faster:rtdetr-Faster"
"rtdetr-fadc:rtdetr-fadc"
"rtdetr-FreqFFPN:rtdetr-FreqFFPN"
"rtdetr-gConvC3:rtdetr-gConvC3"
"rtdetr-iRMB:rtdetr-iRMB"
)
