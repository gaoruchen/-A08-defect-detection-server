...
if __name__ == '__main__':
    ...
    model(r'/home/chuangxin/gaoruchen/detr-main/data/images/val', 'runs/heatmap')
    # model(r'/home/chuangxin/gaoruchen/rtdetr-steel/data/NEU-DET/images/val', 'runs/heatmap')
