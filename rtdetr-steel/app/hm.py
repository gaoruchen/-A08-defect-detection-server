...
#     path = 'D:/PythonProject/yolo11-steel/dataset/images/val/000a4bcdd.jpg'
#     model = rtdetr_heatmap(**get_params())
#     # model(r'/home/lihan/Code/rtdetr/heatmap/images', 'result')
#     model(path, 'heatmap')

def get_model_hm():
    return rtdetr_heatmap(**get_params())
