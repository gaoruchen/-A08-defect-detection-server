...
def get_params():
    ...
    params_list = [
        {
            # r18
            'weight': 'runs/train/LCAF/a_useful/flirv1-rtdetr-r18-e100-bs16-/weights/best.pt',
            'device': 'cuda:0',
            'method': method,
            'layer': [15, 19, 22, 25],
        ...
        {
            # LARM
            'weight': 'runs/train/LCAF/a_useful/flirv1-rtdetr-CFC_Reformer-e100-bs4-gpu0-/weights/best.pt',
            'device': 'cuda:0',
            'method': method,
            'layer': [15, 19, 22, 26],
            'backward_type': backward_type,
        ...
        {
            # ASFM
            'weight': 'runs/train/LCAF/a_useful/flirv1-rtdetr-CFC-SFCAK-e100-bs4-gpu0-/weights/best.pt',
            'device': 'cuda:0',
            'method': method,
            'layer': [15, 19, 22, 27],
            'backward_type': backward_type,
        ...
        {
            # LCAF
            'weight': 'runs/train/LCAF/a_useful/flirv1-rtdetr-CFCRe-SFCAK-e100-bs4-gpu1-/weights/best.pt',
            'device': 'cuda:0',
            'method': method,
            'layer': [15, 19, 22, 27],
            'backward_type': backward_type,
        ...
        {
            # LCAF_USE
            'weight': 'runs/train/LCAF/a_useful/flirv1-rtdetr-CFCRe-SFCAK-use_emasvfl-e100-bs4-gpu0-/weights/best.pt',
            'device': 'cuda:0',
            'method': method,
            'layer': [15, 19, 22, 27],
            'backward_type': backward_type,
...
if __name__ == '__main__':
    ...
    model(r'heatmap/images', 'heatmap_result_LARM')

    model = rtdetr_heatmap(**get_params()[2])
    model(r'heatmap/images', 'heatmap_result_ASFM')

    model = rtdetr_heatmap(**get_params()[3])
    model(r'heatmap/images', 'heatmap_result_LCAF')

    model = rtdetr_heatmap(**get_params()[4])
    model(r'heatmap/images', 'heatmap_result_LCAF_USE')
